...
If there is one recommendation I should make, it would be to make sure you get yourself a high quality sewing thread. Lower quality will probably have enough strength to hold the seams together (decent tensile strength) but sewing with them will soon become a nightmare. The main issue with lower quality products is the uneven weaving of the filaments that can leave bulges and notches along the thread. These imperfections will catch on anything they can on your sewing machine, or the thread might tear for no apparent reason. Plus, I find using high quality thread much more forgiven when used in a sewing machine which tension is not perfectly calibrated.
